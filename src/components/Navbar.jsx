...
const Navbar = ({ onDemoClick }) => {
  ...
  return (
    <nav className="left-0 w-full flex justify-between items-center px-4 z-10  fixed top-0 ">
      {/* Logo */}
      ...
      {/* Get a Demo Button */}
      <button
        className="bg-red-600 text-white px-5 py-2 rounded-full hover:bg-red-700 text-xl/7 hidden md:block"
        onClick={onDemoClick}
      >
        Get a Demo
      </button>
